...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HttpRedirect.redirect_timestamp'
        db.add_column('spyglass_httpredirect', 'redirect_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2000, 1, 1, 0, 0, 0, 0), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HttpRedirect.redirect_timestamp'
        db.delete_column('spyglass_httpredirect', 'redirect_timestamp')
